...
Use max value of the biggest sample
...
tree_raster   <- rast("tree_cover_density_2012_100m_3035.tif")
imperv_raster <- rast("imperviousness_2012_100m_3035.tif")
noise_raster  <- rast("noise_daynight_2017_100m_3035.tif")

water_raster  <- rast("water_bodies_2010_100m_3035.tif")
...
## Predict the model
```{r}
sp_rich_pred <- raster::predict(object = my_env_stack_2, 
                                model = birds_model)
sp_rich_pred
