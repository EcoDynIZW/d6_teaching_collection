...
<br> 
Disclaimer: This is not a beginner's course to learn R! To deepen your R skills, I recommend the tutorials of <br> 
...
<br>
I am actually a big fan of R cheat sheets which provide the basic functions in an overview format. For this course, please download and use the base R cheat sheet here: <br>
...
root_wd <- get_wd() # which has been set in the previous step to the wanted location
