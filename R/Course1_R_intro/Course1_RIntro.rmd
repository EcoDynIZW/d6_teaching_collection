...
Please set your OWN working directory! That is, the path in your computer to the 
folder where you want to save your course script and material. Use 
function `paste()`.
...
output_wd <- paste("C:/Users/kramer/PopDynIZW Dropbox/Steph Kramer", "/", "output_to_delete", sep = '')
```
