...
Change the graphical parameters to change the style of your plot. Please explore yourself what `cex`, `cex.lab`, `las`, `pch` et means by using the help
```{r, eval=-c(2,3)}
# now have a look at
?base::plot # and
...
Or - have a look at the new link of the file (after clicking on it in the repository
directly)!
