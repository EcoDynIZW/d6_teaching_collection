...
The first outline of this course has been developed in 2012 by Alex Courtiol and has ever since 'evolved' in courses I gave and polished by Moritz and Cedric. This short intro contains the most important commands and functions to handle and manipulate data and to follow the course 'biodiversity dynamics. Open your RStudio and type or paste the lines in the grey boxes into your R script, run the lines and follow the course... Or: Click on *Code/Download ZIP* and download and unzip the folder. However, for learning reasons, I actually recommend to even type the functions and commands by hand!

For deepening your R skills, I recommend the tutorials of  

* https://ourcodingclub.github.io/tutorials.html

They provide screenshots and glossaries of the most important functions at the end.
<br>
I am actually a big fan of R cheat sheets which provide the basic functions in an overview format. For this course, please download and use the base R cheat sheet here: 
* https://iqss.github.io/dss-workshops/R/Rintro/base-r-cheat-sheet.pdf


## Setting the work directory

Please set your OWN working directory if you have not used our folder structure. That is, the path in your computer to the folder where you want to save your course script and material. Use 
function `paste()`.

```{r, eval=FALSE}
getwd() # check where you are on your PC, change the work directory (wd) to your folder

# e.g. by setting the work directory (wd) explicitly:

#setwd('M:/IZW/github_local_Mdrive/d6_teaching_collection') # adjust if needed and run the line!
#-- no need to do so if you created an R-project! --

# to keep folders clean, store all output in a separate folder
# Please note: for now, this is just text/ a string 
# pointing to a location in your directory, not yet a folder!
#output_wd <- paste("M:/IZW/github_local_Mdrive/d6_teaching_collection", "/", "output", sep = '') #TODO funktioniert nicht
```
