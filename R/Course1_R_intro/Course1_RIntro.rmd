...
```{r}
# TODO: change url as image is not available anymore
```
...
```{r, eval=FALSE}
# TODO: rphylopic has changed function names and arguments, the for loop doesn't work anymore
...
drfly <- get_phylopic("2894776f-a2cf-4475-b13d-6d8ea1607ea4", height = 128)
bufly <- get_phylopic("ef0f4ab5-9714-45dc-8760-57e9080f941e", height = 128)

p1 <- ggplot(mydata, aes(x = wind_speed, y = wingspan)) + 
        geom_point() + 
        add_phylopic(img = drfly, x = 60, y = 170) + 
