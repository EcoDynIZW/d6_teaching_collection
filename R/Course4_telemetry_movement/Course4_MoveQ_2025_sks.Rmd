...
```{r}
## package names:
pkgs = c("here", "lubridate", "sf", "sp", "raster", "ggplot2", "tmap", "circular", "move", "adehabitatHR", "viridis", "devtools", "plotly","move2", "amt", "terra","ggeffects","tidyterra") 
...
library(ggeffects)     ## for visualizing model results
...
Plot the odds ratio. An odds ratio of 1 indicates that the condition or event 
...
```{r}
sjPlot::plot_model(rsf_fox, transform = "plogis")
sjPlot::plot_model(rsf_fox, vline.color = "red")
```
