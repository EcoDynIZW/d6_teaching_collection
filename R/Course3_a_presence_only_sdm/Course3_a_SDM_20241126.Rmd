...
# read the file
sp_recs <- read.csv(file = spec_pt_filename[1], # decide which species you want to use
                    header=TRUE, sep=',')
...
```{r}
predictors_selected<- terra::rast(x = c(files)) # here you can select which predictors you want to use
```
