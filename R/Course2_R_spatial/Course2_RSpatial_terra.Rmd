...
A small hint on file and folder naming: Do NOT! use dots (NOT: folder.name) 
or special signs like ö, ä, ü, ß etc. in your folder names, 
and keep them at a maximum of 13 letters!
<br>
...
converted to a conventional data frame first, which contains the x-y coordinates.
