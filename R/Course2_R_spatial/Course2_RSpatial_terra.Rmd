...
### Optional: Visualising with the `{ggplot2}` package

optional; for advanced R-users familiar with `ggplot()` coding style: Beautiful plots can also be made with `{ggplot2}`; 
...
<details><summary> Optional - violin plots in ggplot2 </summary>
...
Retrieve metrics/ statistics from the rasterLayers:
