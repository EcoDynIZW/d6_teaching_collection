...
Hint: you can calculate the area for single features (e.g. one polygon) or across the whole dataset.

```{r}
st_area(x = Borneo_shp[3, ]) ## for a single polygon
head(st_area(x = Borneo_shp, byid = TRUE)) ## for all polygons when byid = TRUE
```
